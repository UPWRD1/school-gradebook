...
public class SClassRunner
{
public static void main( String args[] )
{
SClass test = new SClass("Comp Sci 1",4);
...
out.println("Failure List = " + test.getFailureList(70));out.println("Highest Average = " +
test.getStudentWithHighestAverage());
